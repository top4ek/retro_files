---
name: BASIC 2.997 для Вектора-06Ц
date: 2025
tags:
  - basic-dev
  - development
...
2.995
85. Теперь, как в 2.5, можно редактировать и печатать в листинге строки длиной до 127 символов.
86. Скорость умножения вернулась на уровень 2.993
87. Немного ускорил рисование линий.

2.995fix
88. Исправлена реакция на клавишу F5 (ошибка появилась в 2.995).
...
В каталоге RIP вариант упакованный соответствующим упаковщиком, он распаковывается дольше (4.8 секунды вместо 1), но на 224 байта короче.
В комплекте bas2997.wav - файл для быстрой (13.8 секунд) загрузки в реал через магнитофонный вход.

Автор модификации - Иван Городецкий, Уфа 08.06.2019-09.06.2025

![Screenshot 1](basic.png)
